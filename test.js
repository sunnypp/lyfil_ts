...
const tests = [
  ...
  [ [ 'xx', 'a', { dictionary: { a: { xx: [ { loss: 1, result: ['2'] }, { loss: 0, result: ['1'] } ] } } } ], { loss: 0, result: [ '1' ] }, 'Use the cached value with the least loss' ],
  [ [ 'xx', 'a', {
    dictionary: { a: { xx: [ { loss: 1, result: ['2'] }, { loss: 0, result: ['1'] } ] } },
    pick: rs => rs[0],
